...
def main():
    parser = ArgumentParser(description='Causal Neural Style Transfer Model', allow_abbrev = True)
    parser.add_argument('--model', type=str, required = True, help = 'Model Name (e.g.: vgg16, vgg19)')
    
    
    """ Augmentations: already defined in the dataset 
