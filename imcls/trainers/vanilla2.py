...
class Vanilla2(TrainerX):
    ...
    #     if (self.register_check == False):
    #         self.model.backbone.register_fc(self.model.classifier)
    #         self.pseudo_resnet18.load_state_dict(self.model.backbone.state_dict())
    #         print('GO HERE')

    #         torch.save(self.pseudo_resnet18.state_dict(), os.path.join(self.cfg.OUTPUT_DIR, 'resnet18_erm.pt'))

    #         self.register_check = True
    #         self.grad_cam_extractor = SmoothGradCAMpp(self.pseudo_resnet18).to(self.device)
    #         print('GO HERE')
